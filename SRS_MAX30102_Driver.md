...
## MAX30102/MAX30102 Sensor Driver — Zephyr RTOS

| Field | Value |
|---|---|
| Document ID | SRS-MAX30102-001 |
| Version | 1.0 |
...
This document specifies the software requirements for the MAX30102/MAX30102
...
- Initialising and configuring the MAX30102/MAX30102 sensor hardware
...
Specification (SDS-MAX30102-001) and the Failure Mode and Effects Analysis
(FMEA-MAX30102-001).
...
| FIFO | First-In-First-Out hardware sample buffer inside the MAX30102 |
...
saturation. The driver sits between the MAX30102 hardware and the application
algorithm layer.

```
[Application: HR / SpO2 Algorithms]
           ↕  Zephyr Sensor API
  [MAX30102 Driver — this unit]
           ↕  I2C bus + GPIO INT
    [MAX30102 Hardware Sensor]
```
...
register and confirming it matches the expected value (0x15 for MAX30102) before
...
800, and 1000 samples per second as defined in the MAX30102 datasheet.
...
reliability failures identified in FMEA-MAX30102-001 FM-007.*
...
**CON-001** — The driver assumes the MAX30102 is the only device at I2C
...
| Requirement | Design Section (SDS-MAX30102-001) | FMEA Entry |
|---|---|---|

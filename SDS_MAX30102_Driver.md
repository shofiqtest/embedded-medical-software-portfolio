...
| Field | Value |
|---|---|
| Document ID | SDS-MAX30102-001 |
| Version | 1.0 |
| Author | Md Shofiqul Islam |
| Date | 2026-06-10 |
| Status | Released |
| Reference | SRS-MAX30102-001, Zephyr PR #108697, IEC 62304:2006/Amd 1:2015 |

---

## 1. Purpose and Scope

This document describes the software design of the MAX30102/MAX30102 sensor driver
...
| FIFO | First-In-First-Out hardware buffer inside the MAX30102 sensor |
...
┌──────────────────────▼──────────────────────────────┐
│            MAX30102 Driver (this component)          │
│                                                      │
│  ┌─────────────┐  ┌──────────────┐  ┌────────────┐  │
...
2. Verify I2C communication — read PART_ID register (expected: 0x15 for MAX30102)
...
| Parameter | Value |
|---|---|
| I2C address | 0x57 (fixed, MAX30102 hardware) |
...
See companion document: `SOUP_Record_MAX30102_Driver.md`
...
3. The MAX30102 INT pin is connected to a GPIO capable of edge-triggered
   interrupts.
4. Supply voltage is 1.8 V for I2C interface, 3.3 V for LED supply, per
   MAX30102 datasheet Table 1.

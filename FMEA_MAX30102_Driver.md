...
|---|---|
| Component | Initialisation Subsystem |
| Function | Confirm MAX30102 PART_ID = 0x15 at boot |
...
| Effect on System | Driver configured for MAX30102 but reading data from wrong sensor |
...
| Probability | 1 (Improbable — I2C address 0x57 is MAX30102-specific; requires assembly defect) |
| Risk | **5 — LOW** |

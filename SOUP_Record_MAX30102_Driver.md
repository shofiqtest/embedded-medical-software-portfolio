...
communication with the MAX30102 sensor hardware.
...
- Checksum: MAX30102 PART_ID read at initialisation provides implicit communication check
...
**Intended use:**
Configures the MAX30102 INT pin as a falling-edge interrupt source and registers
...
3. Re-run full driver test suite (see FMEA_MAX30102_Driver.md for test coverage)
